        ...
        <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
          <div className="flex justify-center mb-10">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-black text-white tracking-tight italic"><span className="text-indigo-500">Portal</span></h1>
            </div>
          </div>
                  ...
                  <div key={t.id} className="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:border-indigo-500/30 transition-all group">
                    <div className="flex items-start justify-between mb-6">
                      <div className="space-y-1">
                        <div className="flex items-center gap-3">
                          <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${t.status === 'open' ? 'bg-amber-500/20 text-amber-500 border border-amber-500/20' :
